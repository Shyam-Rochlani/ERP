        ...
        if($_GET['q'] == 'success'){
            ...
            if($_GET['status'] == 'customer'){
                echo "<div class='alert alert-danger'>
                    <button class='close' data-close='alert'></button> HSN Code already exists in customer! </div>";
            }
...
?>                                            
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <textarea name="customer_address" id="" palceholder="Customer Address" class="form-control" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            <label class="col-md-3 control-label">Customer Contact
                                                    <span class="required"> * </span>
                                                </label>
                                            <div class="col-md-4">
                                                <input type="number" name="customer_contact" class="form-control" placeholder="Customer Contact">
                                            </div>
                                        </div>
