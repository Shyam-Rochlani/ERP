                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select name="supplier_id[]" id="supplier_id" class="form-control" multiple="multiple">
                          <!--multiple attribute is used above to use multiple attribues along with js ,,,,,name is with [] so that we can pass array in post-->
                           <option></option>
                            <?php
                            require_once("scripts/product/operation.php");
       ...
       <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                       <textarea name="additional_specification" id="additional_specification"  placeholder="Description"rows="3" class="form-control"></textarea>
                   </div>
                </div>
            </div>
