    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form name="edit" action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/category/edit.php" method="POST">
                        <div class="form-body">
...
<![endif]-->
    <!-- BEGIN CORE PLUGINS -->
    <script src="edit-category.js" type="text/javascript"></script>
...
toastr["success"]("your successfully edited the category", "Catogery Edit")
</script>
<?php
