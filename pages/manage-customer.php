    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form name="edit" action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/customer/edit.php" method="POST">
                        <div class="form-body">
                           <div class="form-group clearfix">
                            ...
                            <div class="<form-group></form-group> clearfix">
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <textarea name="customer_address" id="customer_address" placeholder="Customer Address" cols="30" rows="10"></textarea></div>
                            </div>
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="customer_email" name="customer-email" class="form-control" placeholder="Customer Email" readonly/> </div>
                            </div>
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="customer_contact" name="customer_contact" class="form-control" placeholder="Customer contact" readonly/> </div>
                            </div>
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="gst_no" name="gst_no" class="form-control" placeholder="gst_no" readonly/> </div>
                            </div>
...
<!--END OF EDIT BUTTON MODAL-->
  ...
  <div class="modal-dialog" role="document">
    ...
    <button type="submit" class="btn red"  name="deleteBtn">Yes</button>
     <button type="submit" class="btn blue"  name="deleteBtn">No</button> 
      </form>
      </div>
    </div>
  </div>
...
<![endif]-->
    <!-- BEGIN CORE PLUGINS -->
    <script src="edit-customer.js" type="text/javascript"></script>
...
toastr["success"]("your successfully edited the customer", "Catogery Edit")
</script>
<?php
...
?>
<?php
    if(isset($_SESSION['status']) && $_SESSION['status'] == DELETE_SUCCESS){
    ?>
    <script>
    toastr.options = {
  "closeButton": true,
...
toastr["success"]("your successfully deleted the customer", "Customer Edit")
</script>
<?php
        unset($_SESSION['status']);
    }
